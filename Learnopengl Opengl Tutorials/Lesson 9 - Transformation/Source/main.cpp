...
int main(int argc,char* argv[]){
    ...
    glm::vec4 matrix_a(1.0f, 0.0f, 0.0f, 1.0f);
    glm::mat4 matrix_b = glm::mat4(1.0f);

    matrix_a = matrix_a * matrix_b;

    std::cout << "Trans Output" << std::endl;
    std::cout << matrix_a.x << '-' << matrix_a.y << '-' << matrix_a.z << '-' << matrix_a.a << std::endl;


    glm::mat4 transformation = glm::mat4(1.0f);

    // translate( matrix, world_coordinates <x,y,z> )
    // rotate( matrix, angle in radians, world_coordinates <x,y,z> )
    // scale( matrix, world_coordinates <x,y,z> )
    ...
    transformation = glm::translate( transformation, glm::vec3( 0.25f, 0.25f, 0.25f) );
