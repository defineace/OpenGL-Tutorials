...
int main(int argc,char *argv[]){
	...
	// Texture
	std::string file_path = "../Resource/Textures/brick.png";
	Texture texture(file_path.c_str(), GL_TEXTURE_2D, GL_TEXTURE0, GL_RGBA, GL_UNSIGNED_BYTE);
	...
	*/
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// Clean the back buffer and assign the new color to it and clear Depth Buffer
