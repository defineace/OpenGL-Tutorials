...
int main(int argc,char *argv[]){
	...
	// Texture
	std::string texture_file_path = "../Resource/Textures/planks.png";
	Texture texture(texture_file_path.c_str(), GL_TEXTURE_2D, 0, GL_RGBA, GL_UNSIGNED_BYTE);
	texture.texUnit(shaderProgram, "tex0", 0);

	std::string spec_file_path = "../Resource/Textures/planksSpec.png";
	Texture planksSpec(spec_file_path.c_str(), GL_TEXTURE_2D, 1, GL_RED, GL_UNSIGNED_BYTE);
